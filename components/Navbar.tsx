    ...
    <nav className='fixed top-0 left-0 z-10 ease-in duration-900 w-full' style={{backgroundColor:`${bgColor}`}}>
        <div className='flex justify-between items-center max-w-[1240px] m-auto p-4 text-white'>
            ...
            <ul className='hidden sm:flex space-x-8' style={{color:`${textColor}`}}>
                ...
                <li><Link className='text-lg hover:text-gray-400' href='/work'>Work</Link></li>
            ...
            {/* Mobile menu */}
                ...
                <ul className='flex flex-col space-y-8'>
                    <li onClick={handleToggle}><Link className='text-4xl hover:text-gray-500' href='/'>Home</Link></li>
                    <li onClick={handleToggle}><Link className='text-4xl hover:text-gray-500' href='#gallery'>Gallery</Link></li>
                    <li onClick={handleToggle}><Link className='text-4xl hover:text-gray-500' href='/work'>Work</Link></li>
                    <li onClick={handleToggle}><Link className='text-4xl hover:text-gray-500' href='/contact'>Contact Us</Link></li>
                </ul>
            </div>
        </div>        
    </nav>
